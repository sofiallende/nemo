 ...
 !        CASE( jp_abl     )    utau_ice & vtau_ice are computed in ablmod
   ...
   SUBROUTINE ice_flx_other
      ...
      DO_2D( nn_hls, nn_hls, nn_hls, nn_hls )   ! needed for qlead
         ...
         !   - it helps avoiding large ice accumulations in small embayments along the Antarctic coast
         !   - it was recommended by Clement Rousset in an email to Noe Pirlet
         !
